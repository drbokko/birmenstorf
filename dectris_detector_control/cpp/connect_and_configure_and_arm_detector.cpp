...
int main(int argc, char *argv[]) {
    ...
    dcu.setDetectorConfig("compression", "bslz4"); //SIMPLON_APIReference_v3p8.pdf ->  To ensure highest stability at full frame rates, DECTRIS strongly advises using bslz4 compression.
